...
The sources for vasp_tools can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/RexGalilae/vasp_tools
.. _tarball: https://github.com/RexGalilae/vasp_tools/tarball/master
